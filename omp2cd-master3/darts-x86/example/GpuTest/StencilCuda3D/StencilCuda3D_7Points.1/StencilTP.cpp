...
Stencil3D7ptGpuKernelWithAllTimeStepsCD::fire(void)
{
    ...
    int gridDimx2 = std::ceil(1.0*nCols/tile_x);
    int gridDimy2 = std::ceil(1.0*nRows/tile_y);
    int gridDimz2 = std::ceil(1.0*nSlices/tile_z);
