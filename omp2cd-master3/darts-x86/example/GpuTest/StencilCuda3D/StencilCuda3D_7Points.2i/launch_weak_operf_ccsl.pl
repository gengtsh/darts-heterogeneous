        ...
        for my $kernel (@kernels) {
            ...
            if (-e $ker) {
                ...
                for (my $idx = 0; $idx < $its; ++$idx) {
                    print $fh  `numactl --interleave=0 $ker $i $j $k $n_iter $n_reps `;
                    #system `operf -e CPU_CLK_UNHALTED:6000 -e INST_RETIRED:6000 -e LLC_MISSES:6000 -e LLC_REFS:6000  -e l2_rqsts:200000 -e l1d:2000000 -e cpl_cycles:2000003 -e icache:200000 -e br_inst_exec:200003:0xff -e br_misp_exec:200003:0xff -e resource_stalls:2000000 -e fp_assist:100003 -e hw_interrupts:100000 -e l2_trans:200000 -e mem_uops_retired:2000000  -t $ker $i $j $k $n_iter $n_reps`;
                    system `operf -e CPU_CLK_UNHALTED:6000 -e INST_RETIRED:6000 -e LLC_MISSES:6000 -e LLC_REFS:6000  -e l2_rqsts:200003 -e cpl_cycles:2000003 -e icache:2000003 -e br_inst_exec:200003:0xff -e br_misp_exec:200003:0xff -e resource_stalls:2000003 -e fp_assist:100003 -e l2_trans:200003 -e mem_uops_retired:2000003  -t $ker $i $j $k $n_iter $n_reps`;
                    #system `operf -e CPU_CLK_UNHALTED:10000 -e INST_RETIRED:10000 -e LLC_MISSES:10000 -e LLC_REFS:10000  -e l2_rqsts:300000 -e cpl_cycles:3000000 -e icache:3000000 -e br_inst_exec:300000:0xff -e br_misp_exec:300000:0xff -e resource_stalls:3000000 -e fp_assist:300000 -e l2_trans:300000 -e mem_uops_retired:3000000  -t $ker $i $j $k $n_iter $n_reps`;
