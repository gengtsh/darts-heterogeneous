...
DEF_CODELET(Stencil2D4ptGpuKernelWithStreamsCD,2,LONGWAIT);
...
DEF_TP(StencilTP)
{
    ...
    Stencil2D4ptGpuKernelWithStreamsCD Stencil2D4ptGpuKernelWithStreams;
	...
	double cmGpu = 5;	//Gpu compute ability
	...
	,signalUp(up)
	{
		...
		if(GpuRatio ==0.0){
			...
			//	}
                ...
                Stencil2D4ptGpuKernelWithStreams = Stencil2D4ptGpuKernelWithStreamsCD{0,1,this,GPUMETA};
                add(&Stencil2D4ptGpuKernelWithStreams);
