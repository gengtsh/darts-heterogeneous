...
#ifdef CUDA_DARTS_DEBUG
            std::cout<<"CpuSync: invoked  new GPU, gpuPos: "<<FRAME(gpuPos)<<std::endl;

            std::cout<<"CpuSync: invoked  new GPU, nRowsGpu: "<<FRAME(nRowsGpu)<<std::endl;

            std::cout<<"CpuSync: invoked  new GPU, nRowsLeft: "<<FRAME(nRowsLeft)<<std::endl;
