...
////			add (&calcHydroConstraintForElemsSync);
			...
			calcHydroConstraintForElemsP1Iter[0]= CalcHydroConstraintForElemsP1IterCD{0,1,this,SHORTWAIT,0};
			add ( calcHydroConstraintForElemsP1Iter+ 0);
			if(N_CORES>1){
				calcHydroConstraintForElemsP1Iter[1]= CalcHydroConstraintForElemsP1IterCD{0,1,this,SHORTWAIT,1};
				add ( calcHydroConstraintForElemsP1Iter+ 1);
			}
		}                                   
