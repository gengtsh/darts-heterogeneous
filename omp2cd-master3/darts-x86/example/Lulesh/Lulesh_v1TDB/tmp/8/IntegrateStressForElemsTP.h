...
////			add (& integrateStressForElemsP2);
			...
			integrateStressForElemsP1Iter[0]=IntegrateStressForElemsP1IterCD{0,1,this,SHORTWAIT,0};	
			add ( integrateStressForElemsP1Iter +0);
			if(N_CORES>1){
				integrateStressForElemsP1Iter[1]=IntegrateStressForElemsP1IterCD{0,1,this,SHORTWAIT,1};	
			add ( integrateStressForElemsP1Iter +1);
			}
		}
