...
{
//	std::cout<<"Nodal: CalcForceForNodesTP finish!"<<std::endl;
	LOAD_FRAME(LagrangeNodalTP);
	Domain *domain=FRAME(domain);
...
{
//	std::cout<<"Nodal:CalcAccelerationForNodesTP finish"<<std::endl;
	LOAD_FRAME(LagrangeNodalTP);
	Domain *domain=FRAME(domain);
...
{
//	std::cout<<"Nodal:ApplyAccelerationBoudaryConditionsForNodesTP finish!"<<std::endl;
	LOAD_FRAME(LagrangeNodalTP);
	Domain *domain=FRAME(domain);
...
{
//	std::cout<<"Nodal: CalcVelocityForNodesTP finish!"<<std::endl;
	LOAD_FRAME(LagrangeNodalTP);
	Domain *domain=FRAME(domain);
