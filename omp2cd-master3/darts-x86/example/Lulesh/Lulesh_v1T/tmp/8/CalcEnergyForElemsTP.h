...
////			add (&calcEnergyForElemsSync);
			...
			calcEnergyForElemsP1Iter[0]=CalcEnergyForElemsP1IterCD{0,1,this,SHORTWAIT,0} ;
			add (calcEnergyForElemsP1Iter +0 );
			if(N_CORES>1){
				calcEnergyForElemsP1Iter[1]=CalcEnergyForElemsP1IterCD{0,1,this,SHORTWAIT,1} ;
				add (calcEnergyForElemsP1Iter +1 );
			}
