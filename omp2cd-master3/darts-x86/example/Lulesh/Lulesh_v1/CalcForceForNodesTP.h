...
////			add (&calcVolumeForceForElems);
				...
				calcForceForNodesP1Iter[0]=CalcForceForNodesP1IterCD{0,1,this,SHORTWAIT,0};
				add (calcForceForNodesP1Iter + 0);
				if(N_CORES>1){
					calcForceForNodesP1Iter[1]=CalcForceForNodesP1IterCD{0,1,this,SHORTWAIT,1};
					add (calcForceForNodesP1Iter + 1);
				}
		}
