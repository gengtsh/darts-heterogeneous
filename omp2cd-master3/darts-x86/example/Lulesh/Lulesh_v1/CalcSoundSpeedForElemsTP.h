...
////			}
			...
			calcSoundSpeedForElemsIter[0]=CalcSoundSpeedForElemsIterCD{0,1,this,SHORTWAIT,0};
			add ( calcSoundSpeedForElemsIter+ 0);
			if(N_CORES>1){
				calcSoundSpeedForElemsIter[1]=CalcSoundSpeedForElemsIterCD{0,1,this,SHORTWAIT,1};
				add ( calcSoundSpeedForElemsIter+ 1);
			}
		}
