...
#  scale_x_continuous(breaks=seq(0,50000,5000)) +
  theme(axis.text.x= element_text(family = "Times", face="bold", size=20, colour = "Black", angle=15, hjust=0.85)) +
...
ggsave(paste("./speedUp-Stencil3D-New3.pdf",sep=""), Graph, device = pdf, height=40, width=30)
