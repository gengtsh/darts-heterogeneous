...
#  scale_x_continuous(breaks=seq(0,50000,5000)) +
  theme(axis.text.x= element_text(family = "Times", face="bold", size=50, colour = "Black", angle=30, hjust=0.85)) +
...
ggsave(paste("./speedUp-Stencil3D-New3_debian.pdf",sep=""), Graph, device = pdf, height=30, width=30)
