...
declare -a Traces=("cuDeviceGetAttribute" "cudaSetupArgument" "cudaMallocHost" "cudaGetDeviceCount" "cudaGetDeviceProperties" "cudaMemGetInfo" "cudaMalloc" "cudaMemcpy" "CUDA memcpy HtoD" "CUDA memcpy DtoH" "cudaFree" "cudaLaunch (gpu_stencil37_hack1_cp_slices" "\"gpu_stencil37_hack1_cp_slices" "cudaLaunch (gpu_stencil37_hack1_cp_rows" "\"gpu_stencil37_hack1_cp_rows" "cudaLaunch (gpu_stencil37_hack1_cp_cols" "\"gpu_stencil37_hack1_cp_cols" "cudaLaunch (gpu_stencil37_hack2" "\"gpu_stencil37_hack2")
