...
for machine in "${Machines[@]}"; do
    ...
    for sizesZXY in "${ZXY[@]}"; do
        ...
        tempMetric=`cat ${machine}_opreport_cpu/operf_StencilCudaCpu37_${sizesZXY}_7_1.txt | awk  '{print $0}' | tail -1`
...
#            var=""
    ...
    mv tempFileMetric ${machine}_opreport_cpu/tempFileMetric.csv
    rm -rf varAll
done
