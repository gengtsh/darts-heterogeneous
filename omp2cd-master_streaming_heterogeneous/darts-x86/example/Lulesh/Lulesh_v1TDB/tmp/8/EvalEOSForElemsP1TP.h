...
////			add (&evalEOSForElemsP1TPSync);
			...
			evalEOSForElemsP1TPP1Iter[0]=EvalEOSForElemsP1TPP1IterCD{0,1,this,SHORTWAIT,0} ;
			add (evalEOSForElemsP1TPP1Iter +0 );
			if(N_CORES>1){
				evalEOSForElemsP1TPP1Iter[1]=EvalEOSForElemsP1TPP1IterCD{0,1,this,SHORTWAIT,1} ;
				add (evalEOSForElemsP1TPP1Iter +1 );
			}
		}
