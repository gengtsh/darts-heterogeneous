...
////			add (&calcCourantConstraintForElemsSync);
			...
			calcCourantConstraintForElemsP1Iter[0]= CalcCourantConstraintForElemsP1IterCD{0,1,this,SHORTWAIT,0};
			add ( calcCourantConstraintForElemsP1Iter+ 0);
			if(N_CORES>1){
				calcCourantConstraintForElemsP1Iter[1]= CalcCourantConstraintForElemsP1IterCD{0,1,this,SHORTWAIT,1};
				add ( calcCourantConstraintForElemsP1Iter+ 1);
			}
