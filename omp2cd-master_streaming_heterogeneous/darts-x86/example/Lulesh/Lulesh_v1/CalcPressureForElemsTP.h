...
////			add (&calcPressureForElemsSync);
			...
			calcPressureForElemsP1Iter[0]=CalcPressureForElemsP1IterCD{0,1,this,SHORTWAIT,0};
			add ( calcPressureForElemsP1Iter+ 0);
			if(N_CORES>1){
				calcPressureForElemsP1Iter[1]=CalcPressureForElemsP1IterCD{0,1,this,SHORTWAIT,1};
				add ( calcPressureForElemsP1Iter+ 1);
			}
		}
