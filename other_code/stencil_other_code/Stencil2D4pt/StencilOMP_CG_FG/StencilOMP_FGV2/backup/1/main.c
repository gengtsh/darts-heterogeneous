...
////===
//	memset(current_values,0,sizeof(double)*n_rows*n_cols);
//	memset(next_values,0,sizeof(double)*n_rows*n_cols);
//	memset(initial_matrix,0,sizeof(double)*n_rows*n_cols);
////===
...
////===	//================verify======================//
////===    double  *seq_matrix = smalloc( sizeof(double) * n_rows * n_cols);
////===
////===	memset(initial_matrix,0,sizeof(double)*n_rows*n_cols);
////===//	memset(seq_matrix,0,sizeof(double)*n_rows*n_cols);
////===	
////===	array2d_init(initial_matrix,n_rows,n_cols); // initial 2D array
////===	
////===//	printf("initial_matrix:\n");
////===//	printf("%f,%f,%f,%f, \n",initial_matrix[0],initial_matrix[1],initial_matrix[2], initial_matrix[3]);
////===//	
////===//	printf("%f,%f,%f,%f, \n",initial_matrix[0+n_cols],initial_matrix[1+n_cols],initial_matrix[2+n_cols], initial_matrix[3+n_cols]);
////===//	
////===//	printf("%f,%f,%f,%f, \n",initial_matrix[0+n_cols*2],initial_matrix[1+n_cols*2],initial_matrix[2+n_cols*2], initial_matrix[3+n_cols*2]);
////===
////===	
...
////===
////===//		printf("seq_matrix:\n");
////===//		printf("%f,%f,%f,%f, \n",seq_matrix[0],seq_matrix[1],seq_matrix[2], seq_matrix[3]);
////===//		printf("%f,%f,%f,%f, \n",seq_matrix[0+n_cols],seq_matrix[1+n_cols],seq_matrix[2+n_cols], seq_matrix[3+n_cols]);
////===//		printf("%f,%f,%f,%f, \n",seq_matrix[0+n_cols*2],seq_matrix[1+n_cols*2],seq_matrix[2+n_cols*2], seq_matrix[3+n_cols*2]);
////===//		
////===//		printf("omp_results:\n");
////===//		printf("%f,%f,%f,%f, \n",next_values[0],next_values[1],next_values[2], next_values[3]);
////===//		printf("%f,%f,%f,%f, \n",next_values[0+n_cols],next_values[1+n_cols],next_values[2+n_cols], next_values[3+n_cols]);
////===//		printf("%f,%f,%f,%f, \n",next_values[0+n_cols*2],next_values[1+n_cols*2],next_values[2+n_cols*2], next_values[3+n_cols*2]);
////===		
////===		if(result_is_correct(n_rows, n_cols,seq_matrix, next_values ))
////===			printf("success \n");
////===	}else {
////===
////===//		printf("seq_matrix\n");
...
////===//		printf("%f,%f,%f,%f, \n",current_values[0+n_cols],current_values[1+n_cols],current_values[2+n_cols], current_values[3+n_cols]);
////===//		printf("%f,%f,%f,%f, \n",current_values[0+n_cols*2],current_values[1+n_cols*2],current_values[2+n_cols*2], current_values[3+n_cols*2]);
////===
////===		
////===		if(result_is_correct(n_rows, n_cols,initial_matrix, current_values ))
////===			printf("success \n");
////===	}
////===	sfree (seq_matrix);
////===	//================verify======================//
