...
//              DST[1,2] = (SRC[0,2] + SRC[2,2] + SRC[1,1] + SRC[1,3]) / 4;
				...
				// v00          = _mm_shuffle_pd_gcc ( v00,  v01, 1, 1 ); // v00  = [ (0,1), (2,1) ]
                // v01          = _mm_shuffle_pd_gcc ( vsh1, vsh2, 0, 0) ); // v01  = [ (1,0), (1,2) ]
                // v10          = _mm_shuffle_pd_gcc ( v10,  v11, 0, 0 ); // v10  = [ (0,2), (2,2) ]
                // v11          = _mm_shuffle_pd_gcc ( vsh1, vsh2, 1, 1 ); // v11  = [ (1,1), (1,3) ]
