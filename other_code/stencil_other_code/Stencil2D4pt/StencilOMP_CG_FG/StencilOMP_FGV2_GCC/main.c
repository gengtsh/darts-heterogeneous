...
//    double *ompv2_values = smalloc( sizeof(double) * n_rows * n_cols);
    double *ompv3_values = smalloc( sizeof(double) * n_rows * n_cols);
	double *initial_matrix = smalloc( sizeof(double) * n_rows * n_cols);
////===
//	memset(ompv2_values,0,sizeof(double)*n_rows*n_cols);
	memset(ompv3_values,0,sizeof(double)*n_rows*n_cols);
...
////===
	...
	//	stencil2D4pt_omp_v2(ompv2_values, initial_matrix, n_rows, n_cols, n_tm_steps);
	//	stencil2D4pt_omp_v3(ompv3_values, initial_matrix, n_rows, n_cols, n_tm_steps);
		stencil2D4pt_omp_v4(ompv3_values, initial_matrix, n_rows, n_cols, n_tm_steps);
...
////====     for (size_t i = 0; i < n_rows; ++i){ 
////==== 	    for (size_t j = 0; j < n_cols; ++j){
////==== 			printf("%f,",initial_matrix[i*n_cols+j]);
////==== 		}
////==== 		printf("\n");
////==== 	}
////====
...
////====    for (size_t i = 0; i < n_rows; ++i) {
////====	    for (size_t j = 0; j < n_cols; ++j){
////====			printf("%f,",seq_matrix[i*n_cols+j]);
////====		}
////====		printf("\n");
////====	}
////====	printf("ompv2_results:\n");
////====    for (size_t i = 0; i < n_rows; ++i) {
////====	    for (size_t j = 0; j < n_cols; ++j){
////====			printf("%f,",ompv2_values[i*n_cols+j]);
////====		}
////====		printf("\n");
////====	}
////====	printf("ompv3_results:\n");
////====    for (size_t i = 0; i < n_rows; ++i) {
////====	    for (size_t j = 0; j < n_cols; ++j){
////====			printf("%f,",ompv3_values[i*n_cols+j]);
////====		}
////====		printf("\n");
////====	}
////====    //if(result_is_correct(n_rows, n_cols,seq_matrix, next_values ))
////====    if(result_is_correct(n_rows, n_cols,seq_matrix, ompv3_values ))
////====    	printf("success \n");
////====    sfree (seq_matrix);

////====	if(result_is_correct(n_rows, n_cols,ompv2_values, ompv3_values ))
////====		printf("success \n");
////===	//================verify======================//
