...
void
init_loop ( double* __restrict dst, double * __restrict src, const size_t n_rows, const size_t n_cols )
{
...
//stencil fine grain taskgroup taskloop simd
void stencil2D4pt_omp_v4 ( double* restrict dst,    double* restrict src, 
                      const size_t     n_rows, const size_t     n_cols,
                      const size_t     n_tsteps )
{
    typedef double (*Array2D)[n_cols];
